...
public class ProfileEditSelerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_edit_seler);
            ...
            ref.child(firebaseAuth.getUid()).updateChildren(hashMap)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(ProfileEditSelerActivity.this, "Profile update", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(ProfileEditSelerActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            storageReference.putFile(image_uri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Uri downloadImgaeUri = uriTask.getResult();
                            if (uriTask.isSuccessful()) {
                                ...
                                hashMap.put("profileImage", "" + downloadImgaeUri);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResualt) {
        switch (requestCode) {
            ...
            case STORAGE_REQUEST_CODE: {
                if (grantResualt.length > 0) {
                    boolean storageAccepted = grantResualt[0] == PackageManager.PERMISSION_GRANTED;
