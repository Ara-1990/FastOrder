...
public class RegisterUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerSeler = findViewById(R.id.registerSeler);
        ...
        registerSeler.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(RegisterUserActivity.this, RegisterSelerActivity.class));
            }
        });
    ...
    private String fullName, phone, email, password, compirmPassword;
    ...
    private void saveFirebaseData() {
        ...
        if (image_uri == null) {
            ...
            hashMap.put("compirmPassword", "" + compirmPassword);
